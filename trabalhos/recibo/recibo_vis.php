<html>
	...
	/* Fim extenso */
		...
		?>
		<button id="botaoimprimir" onclick="window.open('imprimir.php','Recibo','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1000,height=1000'); ">Imprimir</button>
			<br>
			<div class="objetivo">
